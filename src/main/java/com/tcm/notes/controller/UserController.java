...
public class UserController {
    ...
    public ResponseEntity<Map<String, Object>> getCurrentUserStatistics() {
        ...
        statistics.putAll(studyStats);
        
        // 获取笔记数量
        long notesCount = noteService.findByUserId(userId).size();
        ...
        // 获取学习天数（基于学习记录的不同日期数量）
        long studyDays = studyRecordService.getStudyDaysCount(userId);
        statistics.put("studyDays", studyDays);
